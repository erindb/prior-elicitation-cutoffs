...
//TODO: randomize name-object pair
var allConditions = 
[
[
...
{"domain":"headphones","modifier":"a pair of","buyer":"John"},
{"domain":"coffee maker","modifier":"a","buyer":"Dave"},
],
];
...
var experiment = {
  ...
  next: function() {
    if (numComplete > 0) {
      ...
      var probPrice10 = parseInt(document.getElementById("hiddenSliderValue10").value) / 40.00;
      var probPrice11 = parseInt(document.getElementById("hiddenSliderValue11").value) / 40.00;
      var probPrice12 = parseInt(document.getElementById("hiddenSliderValue12").value) / 40.00;
      var probPrice13 = parseInt(document.getElementById("hiddenSliderValue13").value) / 40.00;
      var probPrice14 = parseInt(document.getElementById("hiddenSliderValue14").value) / 40.00;
      var probPrice15 = parseInt(document.getElementById("hiddenSliderValue15").value) / 40.00;
      var probPrice16 = parseInt(document.getElementById("hiddenSliderValue16").value) / 40.00;
      var probPrice17 = parseInt(document.getElementById("hiddenSliderValue17").value) / 40.00;
      var probPrice18 = parseInt(document.getElementById("hiddenSliderValue18").value) / 40.00;
      var probPrice19 = parseInt(document.getElementById("hiddenSliderValue19").value) / 40.00;
      ...
      experiment.inferredPrices1[currentTrialNum] = probPrice10;
      experiment.inferredPrices1[currentTrialNum] = probPrice11;
      experiment.inferredPrices1[currentTrialNum] = probPrice12;
      experiment.inferredPrices1[currentTrialNum] = probPrice13;
      experiment.inferredPrices1[currentTrialNum] = probPrice14;
      experiment.inferredPrices1[currentTrialNum] = probPrice15;
      experiment.inferredPrices1[currentTrialNum] = probPrice16;
      experiment.inferredPrices1[currentTrialNum] = probPrice17;
      experiment.inferredPrices1[currentTrialNum] = probPrice18;
      experiment.inferredPrices1[currentTrialNum] = probPrice19;
